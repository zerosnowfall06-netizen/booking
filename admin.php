...
// 1. ระบบกดออกจากระบบ (Logout) -> ย้ายขึ้นบนสุดเพื่อล้างค่า Session ทันทีเมื่อกดปุ่ม
...
// 2. [ระบบความปลอดภัย] เช็กสิทธิ์ล็อกอิน: ถ้ายังไม่ได้ล็อกอิน ให้ดีดกลับไปหน้า login.php ทันที
...
<div class="container">
    <div class="calendar-header">
        <a class="btn-nav" href="admin.php?month=<?php echo $prev_month; ?>&year=<?php echo $prev_year; ?>">◀ เดือนก่อนหน้า</a>
        <h1>🗓️ <?php echo $months_th[$month] . " " . ($year + 543); ?></h1>
        <a class="btn-nav" href="admin.php?month=<?php echo $next_month; ?>&year=<?php echo $next_year; ?>">เดือนถัดไป ▶</a>
    </div>

    <div class="logout-box">
        <a href="admin.php?action=logout" class="btn-logout" onclick="return confirm('คุณต้องการออกจากระบบใช่หรือไม่?')">[ 📴 ออกจากระบบผู้ดูแลระบบ ]</a>
    </div>
